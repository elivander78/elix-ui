<template>
  <div class="docs-page">
    <h1>Spinner</h1>
    <p>The Spinner component is used to indicate a loading state.</p>

    <h2>Basic Usage</h2>
    <Playground :demo-component="SpinnerBasicDemo" :code="basicCode" />

    <h2>With Overlay</h2>
    <Playground :demo-component="SpinnerOverlayDemo" :code="overlayCode" />
  </div>
</template>
